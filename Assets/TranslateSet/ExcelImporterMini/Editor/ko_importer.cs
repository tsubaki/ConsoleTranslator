...
public class ko_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/TranslateSet/Editor/language/ko.xls";
	private static readonly string exportPath = "Assets/TranslateSet/Editor/language/ko.asset";
